...
function SignupWithLinkedIn() {
  ...
  return (
    <div className="login-content-container">
      ...
      <div className='text-center'><p>You are currently logged out of Jayla,<br />
to access your account and sync<br />
with LinkedIn, click on the Chrome<br />
Extension icon to the top right<br />
and click sign in.</p></div>
    </div>
  );
}
