...
function Crm() {
  ...
  const state = {
    labels: ['Initial Contact', 'In Conversation', 'Meeting Booked',
      'Follow-Up', 'Potential Deals', 'Closed', 'Lost'],
    datasets: [
      {
  ...
  return <>
    ...
    <div className='d-flex jc-bet ai-f-end'>
      ...
      <div className='d-flex'>
        <button type='submit' className='button success-button slim-button mr-10'>APPLY</button>
        <button type='button' className='button primary-button slim-button'>RESET</button>
      </div>
    </div>
