...
function Reporting() {
  ...
  const totalSalesData = {
    labels: ['Sep 20', 'Oct 20', 'Nov 20',
      'Dec 20', 'Jan 21', 'Feb 21', 'Feb 21', 'Mar 21', 'Apr 21', 'May 21', 'Jun 21', 'Jul 21', 'Aug 21', 'Sep 21', 'Oct 21', 'Nov 21', 'Dec 21'],
    datasets: [
      {
        data: [0, 4000, 16000, 24000, 38000, 67000, 101000, 117000, 124000, 127000, 156000, 174000, 205000, 214000, 228000, 234000, 246000],
  ...
  return (
    <>
      <div className='total-sales-container'>
        <div className='common-title mb-10'>
