    ...
    <>
      <div className='opportunity-header'>
        <div className='breadcrumb common-subtitle'>
          ...
          <span> / OPPORTUNITY DETAILS</span></div>
        <div className='buttons-row'>
          <button type='submit' className='button success-button'>SYNC</button>
          <button type='button' className='button danger-button'>DELETE OPPORTUNITY</button>
        </div>
      </div>

      <div className='warning'>
        <span>!</span>
        Only add opportunities that are good prospects, we don&apos;t recommend adding someone before a
        conversation has opened up on LinkedIn.
      </div>
        ...
        <div className='opportunity-left'>
          <div className='common-block blue'>
            ...
            <div className='common-block--detail-container'>
                ...
                <div className='DP-name-container'>
                  ...
                  <div>
                    <div>
                      ...
                      <button type='button' className='button primary-button slim-button mt-10'>LinkedIn Profile
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <button type='submit' className='button success-button mt-20'>SAVE</button>
            </div>
          </div>
          <div className='notes-container'>
            ...
            <div className='add-new-note-container'>
              ...
              <button type='button' className='button success-button'>ADD</button>
            </div>
          </div>
        </div>
